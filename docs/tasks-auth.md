...
| TA-02 | DB 마이그레이션: `users`, `refresh_tokens`, `auth_events`, `rate_limit_buckets` | F-01, F-07, F-14, F-15, F-06 | — | Todo | `feat/TA-02-schema` |
| TA-03 | 공통 암호화 유틸 (AES-GCM, HMAC-SHA256, argon2id, RSA-OAEP) | F-02, F-03, F-11 | TA-01 | Todo | `feat/TA-03-crypto-utils` |
...
| TA-14 | 초기 관리자 시드 스크립트 (`scripts/seed_admin.py`, env 1회 주입) | F-13 | TA-02, TA-03 | Todo | `feat/TA-14-seed-admin` |
...
| TA-19 | 에러 페이지 5종 (401/403/404/500/offline) + 공통 디자인 | F-12 | TA-15 | Todo | `feat/TA-19-error-pages` |
